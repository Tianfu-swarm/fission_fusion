...
public:
    Controller() : Node("controller")
    {
        ...
        rad_data_subscription_ = this->create_subscription<std_msgs::msg::Float64MultiArray>(
            "rab_data", 10, std::bind(&Controller::rab_data_callback, this, std::placeholders::_1));
...
private:
    ...
    void rab_data_callback(const std_msgs::msg::Float64MultiArray::SharedPtr msg)
    {
        rab_data = *msg;
    }
    ...
    rclcpp::Subscription<std_msgs::msg::Float64MultiArray>::SharedPtr rad_data_subscription_;
    //publisher
